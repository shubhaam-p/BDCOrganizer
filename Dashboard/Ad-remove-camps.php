...
<title>Admin- Remove camps</title>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                include 'connection.php';
                                                                $sql = "SELECT * FROM event WHERE Status ='A' ";
                                                                ...
                                                                while ($result = mysqli_fetch_assoc($exe)) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>" . $result['Venue'] . " </td> 
                                                                        <td >
                                                                            <a href='Ad-status-change.php?on=$result[ID] &s=D '> <input type='button' value='Remove'> </a>
                                                                        </td>
                                                                    </tr>
                                                                    ";
                                                                }
