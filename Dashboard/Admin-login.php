                                            ...
                                            <div class="col-sm-12">
                                                <section class="login-block" style="background-color: #c6e4fc;">
                                                    <div class="container-fluid">
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <form class="md-float-material form-material" action="Admin-check-login.php" method="post" name="oform" onsubmit="return validateForm()">
...
<script>
    ...
    if (!/^\S{1,}$/.test(name)) {
        seterror("name", "Cant contain whitespaces");
        returnval = false;
    } 
    return returnval;
    }
